...
//                 [ [ O.navbarFixedLeft(display.navbar, null, "mainNav", ".navLogo.centerBackgroundImage.visualToolsLogoWords", ".visualPressScene") ],
//                   //[ ".visualPressScene.panel.panel-default" ],
...
//     VisualPress.referenceVisual  = new VisualPress.ReferenceVisual    ( display.doubleBuffer);
//     VisualPress.scene            = new VisualPress.VisualPressScene( display.navbar.visualPressScene );
//   };
...
//       function (index, key)
//       { var blueprintItem = VisualPress.modelClasses[key].getBlueprintItem(modals.constructBlueprint, modals.constructBlueprintContainer)[0];
...
//           modelClass.getModelInstance(VisualPress.scene.constructContainer);
//           VisualPress.scene.setCurrentModelClass(modelClass);
//           setTimeout(function() {
...
//   this.VisualPressScene = function(displayScene)
...
//             );
//   }
//   this.VisualPressScene.prototype.setCurrentModelClass = function(modelClass)
...
//             { This[value.name] = new VisualPress.ModelClass(value);
//             }
//         );
//         $.each
//         ( data.iframe,
//             function(key, value)
//             { value["jsonKey"] = key;
//               This[key] = new VisualPress.ModelClass_iframe(value);
//             }
//         );
//         setTimeout
//         ( function() 
//           { VisualPress.display.welcomeOver.toggleClass("opacityZero", true);
     
//             setTimeout
//             ( function()
//               { VisualPress.displayInterface(VisualPress.display);
//               },
//               500
//             );
//           },
...
//           This.modelInstance = new VisualPress.ModelInstance(This, data[0]);
...
//     this.inputFieldHUD  = new VisualPress.InputFieldHUD(this);
//     this.svgHUD         = new VisualPress.SVGHUD(this);
//   }
...
//             var inputField = new VisualPress.ModelFieldInput(This, value);
...
//             var outputField = new VisualPress.ModelFieldOutput(This, value);
...
//             var visualisationField = new VisualPress.ModelFieldVisualisation(This, value);
...
//           new VisualPress.ModelInstance(data.__modelClass, data);
...
//       display.svgTranslatableG.data("visualPress", {"modelInstance": this});
//       display.rootSVG.on
...
//                 var multiplier          = svgReferenceGBBox.height / ((VisualPress.referenceVisual.currentReferenceSVG.height / This.svg3dDisplayJSON.svgRelativeHighness) * (svgVisualisationGBBox["height"]));
...
//     if (!(visualPress.svgStore.hasOwnProperty(svgFileName)))
//     { d3.xml("/static/svg/"+svgFileName+"?ver="+visualPress.graphicLoadVersion, 'image/svg+xml',
//         function(xml)
...
//           //var svgReferenceVisual  = $(visualPress.scene.referenceVisual.getSVGData(This.svg3dDisplayJSON.svgRelativeHighness)).clone();
...
//           visualPress.svgStore[svgFileName]      = $(importedRootG);
//           visualPress.svgDefsStore[svgFileName]  = $(importedDefs);
...
//   { this.display.svgClonableG = visualPress.svgStore[this.svg3dDisplayJSON.svgFile].clone();

//     $(this.display.svgVisualisationG).html(this.display.svgClonableG);

//     if (! this.display.addedSVGDefs)
//     { this.display.svgDefsFromFile = visualPress.svgDefsStore[this.svg3dDisplayJSON.svgFile].clone();
//       $(this.display.svgDefs).html(this.display.svgDefsFromFile);
//       this.display.addedSVGDefs = true;
//     }

//     if (this.userSelectedReferenceSVG)
//     { this.display.svgReferenceG = VisualPress.referenceVisual.getSVGDataByName  (this.userSelectedReferenceSVG            ).clone();
//     }
//     else
//     { this.display.svgReferenceG = VisualPress.referenceVisual.getSVGData        (this.svg3dDisplayJSON.svgRelativeHighness).clone();
//     }
...
//     VisualPress.ReferenceVisualLoader(This, this.svgReferenceDefsByName, refKeys, this, refKeys.length-1, this.svgSelectList);
...
//     }
//     else
//     { VisualPress.ReferenceVisualLoader(referenceVisual, referenceSVGDataDict, refKeys, referenceVisualDefs, index-1, svgSelectList);
//     }
...
//     d3.xml("/static/svg/referenceSVGs/"+referenceSVGData.fileHandle+".svg?ver=" + visualPress.graphicLoadVersion, 'image/svg+xml',
//         function(xml)
//         {
...
//     this.context.cookieManager        = VisualPress.componentCookieManager.register("svg3dCloneTimer");
...
//     display.referenceSVGSelect.on("click", function() { VisualPress.modelInstanceFocus = modelInstance; } );

//     if (! VisualPress.referenceVisual.popoverCreated)
//     { $(document).popover
//       ( { "selector":   ".referenceSVGSelect.hudItem",
//           "container":  "body", 
//           "html":       true, 
//           "title":      "Choose reference visual", 
//           "content":    "<div class='referenceSVGSelectListContainer'>"+VisualPress.referenceVisual.svgSelectList.html()+"</div>", 
//           "placement" : "bottom",
...
//               var modelInstance   = VisualPress.modelInstanceFocus;
...
//       VisualPress.referenceVisual.popoverCreated = true;
...
// // VisualPress.display.hamburger.on('click', function() {
...
//       //   referenceSVGSelectListContainer.append(visualPress.scene.referenceVisual.svgSelectList.clone().show());
...
//           // )
//         // );
//         //visualPress.scene.modelContainerDiv.append(display.customSVGPane);
