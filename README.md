...
To run the Ceptr site locally, there are a few things to set up.
...
_If you're looking to work on the Ceptr site and want access to our accounts, please get in touch_

### Install Node.js and MongoDB

You'll need node 0.10.x and npm 1.3.x installed to run Ceptr. The easiest way is to download the installers from [nodejs.org](http://nodejs.org).
...
When it's all up and running, you should see the message `Ceptr is ready on port 3000` and you'll be able to browse the site on [localhost:3000](http://localhost:3000).
